  ...
  return (
    ...
    <div className="pagination flex justify-center mt-10">
      <div className="join">
        ...
        >
          <FaCircleArrowLeft style={{color: "rgb(240, 185, 11)"}} />
        </button>
        <button className="join-item btn text-2xl" style={{color: "rgb(240, 185, 11)"}}>Trang {productsLoaderData.page}</button>
        <button
          className="join-item btn text-4xl flex justify-center"
          onClick={() => {
        ...
        >
          <FaCircleArrowRight style={{color: "rgb(240, 185, 11)"}}/>
        </button>
      </div>
    </div>
    </>
